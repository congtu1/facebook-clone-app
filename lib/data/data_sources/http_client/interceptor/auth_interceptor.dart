...
// import '../../../../utilities/helpers/network_helper/network_helper.dart';
...
//         DioError(
//           requestOptions: options,
//           error: AppText.value.noInternetConnection,
//         ),
//       );
//       return;
//     }
...
//           error: AppText.value.connectingTimeOut,
//         ),
//       );
//       return;
//     }
...
//     if (accessToken == null) {
//       throw Exception(AppText.value.getRefreshTokenFail);
//     }
...
//     final data =
//         (response.data is String ? jsonDecode(response.data.toString()) : response.data) as Map<String,dynamic>;
//     final dataError = ApiResponseModel.fromJson(data,((p0) => null));
